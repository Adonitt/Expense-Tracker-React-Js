                        ...
                        <Box>
                            <Stack direction="row" alignItems="center" spacing={2} sx={{ mb: 4 }}>
                                <Avatar sx={{
                                    ...
                                    {transaction.type === "INCOME" ? <TrendingUpIcon fontSize="large" /> : <TrendingDownIcon fontSize="large" />}
                                </Avatar>
                                <Box>
                                    <Typography variant="h5" fontWeight="900" color={transaction.type === "INCOME" ? "success.main" : "error.main"}>
                            ...
                            <Grid container spacing={2}>
                                <Grid item xs={12}>
                                    <Paper variant="outlined" sx={{ p: 2, borderRadius: 3, bgcolor: 'action.hover' }}>
                                        ...
                                        <Typography variant="body1" sx={{ fontStyle: transaction.description ? 'normal' : 'italic' }}>
                                ...
                                <Grid item xs={12} sm={6}>
                                    <Stack direction="row" spacing={1} alignItems="center">
                                        ...
                                        <Box>
                                            ...
                                            <Typography variant="body2" fontWeight="600">{transaction.userFullName}</Typography>
                                        </Box>
                                    </Stack>
                                </Grid>
                                ...
                                <Grid item xs={12} sm={6}>
                                    ...
                                    <Typography variant="body2">{new Date(transaction.createdAt).toLocaleString()}</Typography>
                                </Grid>
